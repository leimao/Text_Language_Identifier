...
def read_data(filename):
	# Read data from json-format data file, and return a list of sentences read
	# filename: string
	# return: list
...
def read_label(filename):
	# Read data from json-format data file, and return a list of labels read
	# filename: string
	# return: list
...
def count_language(labelset):
	# Count number of different language in the labelset, and return a dictionary of counts
	# labelset: list
	# return: dict
...
def count_char_utf(dataset):
	# Count number of different utf-8 characters in the dataset, and return a dictionary of counts
	# dataset: list
	# return: dict
...
def extract_n_gram(dataset, labelset, language, n = 2, k = 200):
    # Extract the top k frequent n-grams for a certain language, and return a list of top k n-grams and its corresponding frequence.
    # dataset: list of sentences
    # labelset: list of labels
    # language: string of language code
    # n: integer, n-gram
    # k: integer, top k n-grams
    # return: list of n-gram strings, list of n-gram frequences
        ...
        if label == language:
            ...
            for i in range(length-n+1):
                ...
                if n_gram in n_gram_count:
                    ...
                    n_gram_count[n_gram] = 1
    # Extract the top k most frequent n-grams from all the n-grams
    ...
    # k may be larger than number of all n-grams
...
def extract_n_gram_all(dataset, labelset, languages, n = 2, k = 200):
    # Extract the top k frequent n-grams for all languages, and return a list of combined n-grams
    # dataset: list of sentences
    # labelset: list of labels
    ...
    # Remove the redundent n-grams shown in multiple languages
    # Because the redundent n-grams are removed, the frequence of n-grams will not be returned from this function
