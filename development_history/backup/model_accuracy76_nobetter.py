...
if __name__ == '__main__':
    ...
    three_gram_list = extract_n_gram_all(dataset = data_train, labelset = label_train, languages = list(label_count_train.keys()), n = 3, k = 100)
    ...
    data_n_gram_train = prepare_n_gram_dataset(dataset = data_train, ns = [2,3,4], n_gram_list = two_gram_list + three_gram_list + four_gram_list)
    data_n_gram_val = prepare_n_gram_dataset(dataset = data_val, ns = [2,3,4], n_gram_list = two_gram_list + three_gram_list + four_gram_list)
    data_n_gram_test = prepare_n_gram_dataset(dataset = data_test, ns = [2,3,4], n_gram_list = two_gram_list + three_gram_list + four_gram_list)
    ...
    logreg = linear_model.LogisticRegression(solver = 'lbfgs', n_jobs = 14, max_iter = 20)
